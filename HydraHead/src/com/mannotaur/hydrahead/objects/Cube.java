...
public class Cube {
    ...
    private final int TEX_COORD_COMPONENT_SIZE = 2;
    ...
    private VertexArray positionArray;
    private VertexArray normalArray;

    public Cube() {
        positionArray = new VertexArray(cubePositionData);
        normalArray = new VertexArray(cubeNormalData);
        texArray = new VertexArray(cubeTextureCoordinateData);
    }

    public void bindData(ShaderProgram program) {
        positionArray.setVertexAttribPointer(0,
                program.getAttributeLocation("a_Position"),
                3, 3 * 4);
        normalArray.setVertexAttribPointer(0,
                program.getAttributeLocation("a_Normal"),
                3, 3 * 4);
        texArray.setVertexAttribPointer(0,
                program.getAttributeLocation("a_TexCoordinate"),
                2, 2 * 4);
    }
